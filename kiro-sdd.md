...
- ゆるい感じで進めていければと思っているので、気になったらコメントでも質問でも是非！
- 自然言語処理自体は全く詳しくないので、あくまで開発手法に閉じた話になります
...
GA版で追加された機能。Kiroと仕様駆動開発を行なっていくと、PBTを提案される。
